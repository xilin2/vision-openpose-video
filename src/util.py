...
def npmax(array):
    arrayindex = array.argmax(1)  # returns index of largest value in each column
    arrayvalue = array.max(1) # returns value of largest value in each column
    i = arrayvalue.argmax() # returns x
    j = arrayindex[i] # returns y
    ...
    arrayindex = array.argmax(1)  # returns index of largest value in each column
    arrayvalue = array.max(1) # returns value of largest value in each column
    m = arrayvalue.argmax() # returns
    n = arrayindex[i] # returns y
    
    return i, j, m, n
    '''

# added by Xilin for exp2
# plots points corresponding to hand joints
